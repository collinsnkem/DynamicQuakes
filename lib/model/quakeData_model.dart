...
import 'package:earthquake_app/utils/helpers.dart';
...
class Metadata {
  ...
  Metadata.fromJson(Map<String, dynamic> json) {
    generated = TypeHelper.toInt(json['generated']);
    url = json['url'];
    title = json['title'];
...
class Properties {
  ...
  Properties.fromJson(Map<String, dynamic> json) {
    ...
    place = json['place'];
    time = TypeHelper.toInt(json['mag']);
    ...
    gap = TypeHelper.toDouble(json['gap']);
